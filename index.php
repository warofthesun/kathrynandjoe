	                      ...
	                      <?php printf( __( 'Posted', 'kathrynandjoe' ).' %1$s %2$s',
								...
								<footer class="article-footer ">
									<p class="footer-comment-count">
										<?php comments_number( __( '<span>No</span> Comments', 'kathrynandjoe' ), __( '<span>One</span> Comment', 'kathrynandjoe' ), __( '<span>%</span> Comments', 'kathrynandjoe' ) );?>
									</p>


                 	<?php printf( '<p class="footer-category">' . __('filed under', 'kathrynandjoe' ) . ': %1$s</p>' , get_the_category_list(', ') ); ?>

                  <?php the_tags( '<p class="footer-tags tags"><span class="tags-title">' . __( 'Tags:', 'kathrynandjoe' ) . '</span> ', ', ', '</p>' ); ?>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry ">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the index.php template.', 'kathrynandjoe' ); ?></p>
										</footer>
									</article>
