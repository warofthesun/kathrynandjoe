...
function starter_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date( __( 'j F Y @ g:i a', 'kathrynandjoe' ), $item->get_date( 'Y-m-d H:i:s' ) ); ?>" target="_blank">
...
function starter_custom_dashboard_widgets() {
	wp_add_dashboard_widget( 'starter_rss_dashboard_widget', __( 'Recently on Themble (Customize on admin.php)', 'kathrynandjoe' ), 'starter_rss_dashboard_widget' );
	/*
...
function starter_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://yoursite.com" target="_blank">Your Site Name</a></span>. Built using <a href="http://themble.com/starter" target="_blank">starter</a>.', 'kathrynandjoe' );
}
